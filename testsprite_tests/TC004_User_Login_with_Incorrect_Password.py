...
async def run_test():
    ...
    try:
        ...
        # -> Enter valid email and incorrect password in the login form.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Welcome Back! The journey to better code continues. We\'re glad to see you again.').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Enter your credentials to access your account').first).to_be_visible(timeout=30000)
