...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Get Started' button to proceed to the coding environment or project area where file upload is possible.
        frame = context.pages[-1]
        # Click on 'Get Started' button to proceed to the coding environment or project area.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Data visualization code generated successfully').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The test plan execution failed because the Excel file upload and AI assistant visualization code generation did not complete successfully.")
