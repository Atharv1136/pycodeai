...
async def run_test():
    ...
    try:
        ...
        # -> Enter valid username/email and password, then click the 'Sign In' button.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: User login was not successful, JWT session token was not issued, or redirection to dashboard did not occur as expected.")
